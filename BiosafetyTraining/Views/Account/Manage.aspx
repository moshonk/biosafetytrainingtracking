<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<BiosafetyTraining.Models.LocalPasswordModel>" %>
...
<asp:Content ID="manageContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section id="externalLogins" class="hidden">
