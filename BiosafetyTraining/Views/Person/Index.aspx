<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<BiosafetyTraining.Models.person>>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        <span><span class="icon-users"></span>&nbsp;Persons</span></h2>
    </h2>
    <p>
    ...
    <script type="text/javascript">
        ...
        $().ready(function () {
            $('body').on('click', 'a#create', function () {
                ...
                var url = '<%: Url.Content("~/Person/Create")%>/';
            ...
            $('body').on('click', 'a#delete', function () {
                ...
                var url = '<%: Url.Content("~/Person/Delete")%>/' + id;
            ...
            $('body').on('click', 'a#edit', function () {
                ...
                var id = $(this).attr("refid");
                var url = '<%: Url.Content("~/Person/Edit")%>/' + id;
            ...
            $('body').on('click', 'a#details', function () {
                ...
                var id = $(this).attr("refid");
                var url = '<%: Url.Content("~/Person/Details")%>/' + id;
