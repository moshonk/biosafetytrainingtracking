<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<BiosafetyTraining.Models.location>>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        <span><span class="icon-globe"></span>&nbsp;Training Locations</span></h2>
        </h2>
    <p>
    ...
    <script type="text/javascript">
        ...
        $().ready(function () {
            $('body').on('click', 'a#create', function () {
                ...
                var url = '<%: Url.Content("~/Location/Create")%>/';
            ...
            $('body').on('click', 'a#delete', function () {
                ...
                var url = '<%: Url.Content("~/Location/Delete")%>/' + id;
            ...
            $('body').on('click', 'a#edit', function () {
                ...
                var id = $(this).attr("refid");
                var url = '<%: Url.Content("~/Location/Edit")%>/' + id;
            ...
            $('body').on('click', 'a#details', function () {
                ...
                var id = $(this).attr("refid");
                var url = '<%: Url.Content("~/Location/Details")%>/' + id;
